                    ...
                    Expanded(
                        child: ListView(
                            children: [
                                ...
                                _buildChatHistoryItem('Fine-tune Gemma 12B QLoRA'),
                            ],
                        ),
                    ),
                            ...
                            children: [
                                Row(
                                    children: [
                                        ...
                                        const Text('Gemma 4 12B Active', style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: Colors.white)),
                                    ],
                                ),
                                const SizedBox(height: 6),
                                const Text('Multi-Agent Orchestrator Ready', style: TextStyle(fontSize: 11, color: AppColors.textSecondary)),
                            ],
                        ),
                    ),
                ],
